...
class PeerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_peer_list, container, false)
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyPeerRecyclerViewAdapter(DummyContent.ITEMS, listener)
            }
        }
        return view
    }
